...
- Service and controller layers has been tested.
...
- Then with manager account after manipulation of the products: add, remove, edit you can see information about this in console.